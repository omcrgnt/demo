...
//go:generate go run github.com/omcrgnt/demo/v2/pkg/sdi/cmd/sdigen
//go:generate go run github.com/omcrgnt/demo/v2/pkg/obs/cmd/obsgen -type=Service
...
import (
	...
	"github.com/omcrgnt/demo/v2/internal/domain/model"
