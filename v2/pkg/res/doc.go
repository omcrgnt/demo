...
До [github.com/omcrgnt/demo/v2/pkg/builder].Build в pool лежат config-entry — значения,
реализующие Build() (any, error) ([github.com/omcrgnt/demo/v2/pkg/builder].Builder).
Их регистрируют library use init через [AddWithTags] (Replaceable/Fixed defaults)
и [github.com/omcrgnt/demo/v2/pkg/ecfg].Register из AppConfig ([Add], explicit, без tags).
...
[Registry.Remove] (интерпретирует [github.com/omcrgnt/demo/v2/pkg/sdi] при dedup).
