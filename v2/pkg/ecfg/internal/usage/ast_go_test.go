...
func TestGoUsageFromAST_label(t *testing.T) {
	text, err := GoUsageFromAST("github.com/omcrgnt/demo/v2/pkg/ecfg/internal/testdata", "Label")
	if err != nil {
		t.Fatal(err)
	}
	if text == "" {
...
func TestGoUsageFromAST_missingType(t *testing.T) {
	_, err := GoUsageFromAST("github.com/omcrgnt/demo/v2/pkg/ecfg/internal/testdata", "NoSuchType")
