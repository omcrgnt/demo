...
import (
	...
	"github.com/omcrgnt/demo/v2/pkg/ecfg/pkg/walk"
...
func TestResolveUsage_typesEngineProtoLeaf(t *testing.T) {
	eng, err := walk.NewEngineTypes("github.com/omcrgnt/demo/v2/pkg/ecfg/internal/testdata", "ProtoCfg")
	if err != nil {
		t.Fatal(err)
	}
...
func TestResolveUsage_typesEngineLeaf(t *testing.T) {
	eng, err := walk.NewEngineTypes("github.com/omcrgnt/demo/v2/pkg/ecfg/internal/testdata", "AppConfig")
	if err != nil {
		t.Fatal(err)
	}
	fields, err := eng.Fields()
