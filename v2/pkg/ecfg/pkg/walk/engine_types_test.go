...
func TestNewEngineTypes_ok(t *testing.T) {
	eng, err := NewEngineTypes("github.com/omcrgnt/demo/v2/pkg/ecfg/internal/testdata", "AppConfig")
	if err != nil {
		t.Fatal(err)
	}
...
func TestNewEngineTypes_typeNotFound(t *testing.T) {
	_, err := NewEngineTypes("github.com/omcrgnt/demo/v2/pkg/ecfg/internal/testdata", "NoSuchType")
	if err == nil {
...
func TestStructWalk_typesEngine(t *testing.T) {
	eng, err := NewEngineTypes("github.com/omcrgnt/demo/v2/pkg/ecfg/internal/testdata", "MultiBlock")
	if err != nil {
		t.Fatal(err)
	}
	var names []string
